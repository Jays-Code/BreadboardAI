...
async function main() {
    console.log("=== Sahara Verification Start ===");
    console.log("Running Prompt-to-Post Graph...");

    const inputData: any = {
        topic: "A cinematic journey through the Sahara Desert",
    ...
    try {
        ...
        const outputPath = path.resolve(process.cwd(), "output", "verify_sahara.json");
