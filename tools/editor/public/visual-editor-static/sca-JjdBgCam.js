...
async function qj(n, e, t) {
  const { loader: r, signinAdapter: s, boardServer: i } = t, a = Bj(n, e);
  if (!a.canLoad)
    return { success: !1, reason: a.reason };
  const o = new URL(globalThis.location?.href ?? ""), l = await r.load(a.urlWithResourceKey, {
    base: o
  });
  return !l.success || !l.graph ? await s.state === "signedout" ? { success: !1, reason: "auth-required" } : { success: !1, reason: "load-failed" } : {
    success: !0,
    graph: l.graph,
    boardServer: i
  };
